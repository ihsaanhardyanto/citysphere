...
export default function Sidebar() {
	...
	const buttons = [
		{ id: "your_events", label: "Your Events" },
		{ id: "connections", label: "Connections" },
		{ id: "threads", label: "Threads" },
		{ id: "your_reports", label: "Your Reports" },
	];
	...
	return (
		<div className="flex flex-col">
			<section
				id=""
				className="border-b-[1px] border-black rounded-r-xl p-4 shadow-xl"
			>
			...
			<section id="side_links">
				{buttons.map((button) => (
					<div
						key={button.id}
						id={button.id}
						className={`border-b-2 border-black rounded-r-xl py-8 ${
